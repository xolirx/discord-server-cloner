...
class ConsoleUI:
    ...
    def agreement():
        ...
        print(f"{BLUE}╠{'═' * (ConsoleUI.WIDTH - 2)}╣")
        print(f"{BLUE}║ {WHITE}1. Вы несете ответственность за использование{' ' * (ConsoleUI.WIDTH - 45)} {BLUE}║")
        print(f"{BLUE}║ {WHITE}2. Используйте только на серверах с разрешением{' ' * (ConsoleUI.WIDTH - 48)} {BLUE}║")
        print(f"{BLUE}║ {WHITE}3. Автор не несет ответственности за ваши действия{' ' * (ConsoleUI.WIDTH - 50)} {BLUE}║")
        print(f"{BLUE}║ {WHITE}4. Запрещено нарушение правил Discord{' ' * (ConsoleUI.WIDTH - 42)} {BLUE}║")
        print(f"{BLUE}╚{'═' * (ConsoleUI.WIDTH - 2)}╝")
